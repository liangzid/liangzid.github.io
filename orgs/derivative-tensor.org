...
\begin{equation}
\begin{aligned}
&\frac{dy}{dx}\in\mathbb{d^{O}\times~d^{I}}\\
&\frac{dy}{dW}=W
\end{aligned}
\end{equation}
...
\begin{equation}
\begin{aligned}
&\frac{dy}{dW}\in\mathbb{d^{O}\times~d^{O}\times d_{I}}\\
...
\begin{equation}
\begin{aligned}
&\frac{dy}{dM}\in\mathbb{d^{O}\times~d^{O}\times r}\\
&\frac{dy}{dM}=I_{d_{O}}\otimes (Nx)^{T}=I_{d_{O}}\otimes (x)^{T}N^{T}\\
&\frac{dy}{dN}\in\mathbb{d_{O}\times~r\times d_{I}}\\
